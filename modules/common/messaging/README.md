...
| Key                               | Type   | Default | Description                                                                                                                           | Example                                                                                                                | Required |
| --------------------------------- | ------ | ------- | ------------------------------------------------------------------------------------------------------------------------------------- | ---------------------------------------------------------------------------------------------------------------------- | -------- |
| name                              | String |         | This is the human-readable name of the queue                                                                                          | devops-&lt;TOPIC_NAME&gt;\_dlq # As exists in AWS (including team prefix)                                                         | yes      |
...
| <a name="output_policies"></a> [policies](#output\_policies) | AWS IAM Policy document to allow publish to created topic(s) |
